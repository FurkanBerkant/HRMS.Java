...
import com.kodlamaio.hrms.core.utilities.cloudinary.concretes.CloudinaryManager;
...
public class CloudinaryConfig {
	...
	public Cloudinary cloudinaryUser() {
		return new Cloudinary(
				ObjectUtils.asMap("cloud_name", "dfbyguyot", "api_key", apiKey, "api_secret", apiSecretKey));
	}
